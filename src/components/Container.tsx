...
export default function Container(props: ContainerProps) {
  ...
  const meta = {
    title: "Moyo Africa",
    description: `Moyo leverages artificial intelligence to provide sustainable environmental solutions, empower youth, engage communities, and foster a thriving green economy.`,
  ...
  return (
    <>
      <Head>
        ...
        <meta name="theme-color" content="#0c2b0f" />
        <meta content={meta.description} name="description" />
        <meta
          property="og:url"
          content={`https://www.moyoafrica.org${router.asPath}`}
        />
        <link
          rel="canonical"
          href={`https://www.moyoafrica.org${router.asPath}`}
        />
        <meta property="og:type" content={meta.type} />
        <meta property="og:site_name" content="Moyo Africa" />
        <meta property="og:description" content={meta.description} />
        <meta property="og:title" content={meta.title} />
        <meta property="og:image" content={meta.image} />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:site" content="Moyo Africa" />
      ...
      >
        ...
        <Link href="/">
          <span className="text-lg font-semibold">Moyo</span>
        </Link>
              ...
              <div className="flex h-full flex-col items-start justify-between overflow-y-auto">
                ...
                <div className="flex min-h-fit w-full flex-col space-y-8 px-[22px] py-10">
                  <span className="text-sm text-muted-foreground">
                    © {new Date().getFullYear()} Moyo Africa. All rights reserved.
                  </span>
                </div>
              </div>
            </motion.div>
